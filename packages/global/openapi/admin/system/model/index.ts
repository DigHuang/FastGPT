...
export const AdminSystemModelPath: OpenAPIPath = {
  ...
  '/admin/system/model/createFromTemplates': {
    post: {
      summary: '从模板批量创建模型',
      tags: [DevApiTagsMap.adminSystemModel],
      requestBody: {
  ...
  '/admin/system/model/updateStatus': {
    put: {
      summary: '批量更新模型启停状态',
      tags: [DevApiTagsMap.adminSystemModel],
      requestBody: {
  ...
  '/admin/system/model/getConfigJson': {
    get: {
      summary: '导出模型配置',
      tags: [DevApiTagsMap.adminSystemModel],
      responses: {
  ...
  '/admin/system/model/updateWithJson': {
    put: {
      summary: '导入模型配置',
      description:
  ...
  '/admin/system/model/updateDefault': {
    put: {
      summary: '更新默认模型',
